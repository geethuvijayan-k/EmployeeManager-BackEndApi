...
public class EmployeeService {
	...
	public Optional<Employee> findEmpByNo(Long employee_no) {
		return employeeRepo.findById(employee_no);
	}

	public Optional<Employee> findEmployeeByName(String employee_name) {
		return Optional.of(employeeRepo.findEmployeeByName(employee_name));

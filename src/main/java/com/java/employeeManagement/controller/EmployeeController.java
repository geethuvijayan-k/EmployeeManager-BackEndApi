...
public class EmployeeController {
	...
	@GetMapping("/findByName/{employee_name}") public
	  ResponseEntity<Optional<Employee>> getEmployeeByName(@PathVariable("employee_name") String employee_name){
	     Optional<Employee> employee=employeeService.findEmployeeByName(employee_name);
	  return new ResponseEntity<>(employee, HttpStatus.OK); }
